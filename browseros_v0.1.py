# browserOS Version 0.1, Build 1, Revision 1. Made by Matthew Rinhsamouth, AI, and open source software. Recommended Python 2.5 or later. Tested on Python 3.9.2 and 3.12.1.
# Hello, world.

# start pre-initalization
print("[Overhead/INFO]: I have been summoned.")
print("[Overhead/INFO]: Start OS...")
try:
    import os
except ImportError:
...
def about():
    print("browserOS V 0.1 ALPHA, Revision 1, Build 1. Made in December 6th and finalized December 20th 2023.\nBy Matthew Rinhsamouth, and Google Bard.\n")
...
def firstTimer():
    ...
    if choice == "n" or choice == "no":
        ...
        if choice == "n" or choice == "no":
            ...
            choice = input().lower()
            if choice == "n" or choice == "no":
                print(f"[Func Manager]: Okay, I'm tired of this bullshit. Your name is {name} and it's final.")
...
print("\nbrowserOS Version 0.1 ALPHA Early Dev/Test Release. Build 1. Licensed under the GNU GENERAL PUBLIC LICENSE. All rights reserved.")
soloclass = selfclass()
while True:
    command = input("> ").lower()
    if command == "read":
        ...
        print("'move' - moves a file from a file path to another.")
